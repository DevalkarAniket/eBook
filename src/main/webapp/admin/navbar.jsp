	...
	<div class="clearfix">
		...
		<div class="float-end">
			<c:if test="${not empty userobj}">
				<a href="login.jsp" class="btn btn-success"><i
					class="fas fa-duotone fa-user text-white"></i> ${userobj.name}</a>
		...
		<div>
			<c:if test="${empty userobj}">
				<a href="login.jsp" class="btn btn-success"><i
					class="fas fa-duotone fa-sign-in-alt"></i> Login</a>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom mb-1">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<form class="d-flex">
				<a href="" class="btn btn-light me-2" type="submit"> <i
					class="fas fa-duotone fa-gear"></i> Setting
				</a> <a href="" class="btn btn-light me-2" type="submit"> <i
					class="fas fa-duotone fa-phone"></i> Contact Us
				</a>
			</form>
		</div>
	</div>
